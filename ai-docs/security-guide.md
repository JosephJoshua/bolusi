...
| SEC-DEV-04 | offline-revocation caveat holds | Revoked-while-offline device continues local operation (documented behavior); on reconnect, all queued ops → `DEVICE_REVOKED`, kept + surfaced as `rejected`, none accepted |

...
> **REVIEW FOUND REAL DEFECTS — DO NOT MERGE `task/158-encrypt-media-files-at-rest` until these are fixed (review-wave 2026-08-04, 7 confirmed, all PoC-verified).** The tested cipher + `EncryptingMediaFile` + native wiring + SEC-MEDIA-09 declaration are committed (6 commits), but:

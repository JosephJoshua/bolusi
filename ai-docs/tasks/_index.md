...
| 71 | ledger Status is written twice (index row + file `**Status:**`) and the merge procedure touches one — make the writeback single-action; task 66's gate is only the backstop (from task 66) | todo | 66 |

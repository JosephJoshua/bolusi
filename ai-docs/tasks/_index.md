...
| 115 | `security-guide.md` §12's roll-up says `DEV 01–07` while the body defines **SEC-DEV-08** (shipped by task 58) — the SEC inventory's declared denominator is one id short, so "the SEC suite is complete" is checked against the wrong number (from task 28's inventory) | in-progress | — |

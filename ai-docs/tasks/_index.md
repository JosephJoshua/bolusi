...
| 54 | **SEC-AUTH-06/11 server push-rejection legs are unclaimed and INVISIBLE** — a "client arm" title retired the whole id; guide §162/§167 require them (from task 31) | in-progress | 31 |

...
### Gates (all EXIT=0): `tsc -b`; `pnpm typecheck`; `pnpm lint`; `pnpm knip` (baseline unchanged, +0/-0); `pnpm chaos` (136/136); test-support project (217/217); mobile project (670/670).

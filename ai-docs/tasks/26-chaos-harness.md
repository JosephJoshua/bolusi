...
**SEC-\*:** none owned here — SEC-OPLOG-01..09 live with tasks 03/05/07/15, SEC-SYNC-01..10 with task 16, SEC-AUTH with 13/14 (security-guide §12; the harness covers correctness-under-disorder). This task's adversarial floor per T-9 is **CHAOS-05, CHAOS-10, CHAOS-11, CHAOS-12**, shipped and green IN this task before review-wave (CLAUDE.md §2.5).

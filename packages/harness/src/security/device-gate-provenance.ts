...
/** The pinned artifact whose committed emulator run is leg 1's evidence (buildSha-stamped re-anchor, CI run 34051845063 @ 85d685f). */
export const DEVICE_GATE_ARTIFACT = 'reports/device-gates/2026-09-06-emulator.json';

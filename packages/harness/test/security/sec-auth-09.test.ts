...
//     so its evidence is the COMMITTED artifact `reports/device-gates/2026-09-06-emulator.json` (buildSha-
//     stamped re-anchor run 34051845063 @ 85d685f, driven through the production `writeVerifier`). Trusting that JSON without
